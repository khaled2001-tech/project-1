...
{{-- This layout is used by profile pages for all roles --}}
{{-- It wraps around the existing welcome layout structure --}}
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        ...
                        <a href="{{ route('welcome.vehicle') }}" class="nav-item nav-link {{ request()->routeIs('welcome.vehicle') ? 'active' : '' }}">Vehicle</a>
                    ...
                    @auth
                        <div class="dropdown">
                            <button class="btn btn-primary dropdown-toggle rounded-pill py-2 px-4" type="button" data-bs-toggle="dropdown">
            ...
            <div class="row g-5">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="footer-item d-flex flex-column">
                        ...
                        <a href="{{ route('welcome.vehicle') }}"><i class="fas fa-angle-right me-2"></i> Car Types</a>
