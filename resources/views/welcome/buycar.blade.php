...
@section('title', 'Cental - Our Vehicles')
   ...
   <div class="container-fluid categories py-5">
    <div class="container">
        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
            <h1 class="display-5 text-capitalize mb-3">Cars For <span class="text-primary">Sale</span></h1>
            <p class="mb-0">Browse our available cars for sale.</p>
        </div>
...
<!-- Filter Section End -->
        ...
        <div class="row g-4">
                        ...
                        <div class="categories-content rounded-bottom p-4 d-flex flex-column flex-grow-1">
                            ...
                            <div class="row gy-2 gx-0 text-center mb-4">
                                ...
                                <div class="col-4">
                                    ...
                                    <span class="text-body ms-1">For Sale</span>
                                </div>
                            </div>
            ...
            <div class="col-12 text-center py-5">
                ...
                <p class="text-muted">No Cars Available for Sale</p>
            </div>
            @endforelse
        </div>
