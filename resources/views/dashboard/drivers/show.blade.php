    ...
    <div class="col-md-4 col-lg-3 mb-4">
        <div class="card shadow-sm text-center">
            <div class="card-body pt-4 pb-3">
                ...
                <h5 class="mb-1 font-weight-bold">{{ $driver->name ?? '—' }}</h5>
                ...
                <p class="mb-1 text-muted small">
                    <i class="fas fa-{{ $driver->gender ? 'male' : 'female' }} mr-1"></i>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6 mb-3">
                        ...
                        <p class="mb-0 font-weight-bold">{{ $driver->name ?? '—' }}</p>
                    </div>
                    <div class="col-sm-6 mb-3">
                    ...
                    <div class="col-sm-6 mb-3">
                        ...
                        <p class="mb-0">
                            @if($driver->birthdate)
                                {{ \Carbon\Carbon::parse($driver->birthdate)->format('d M Y') }}
                                <small class="text-muted">
                                    ({{ \Carbon\Carbon::parse($driver->birthdate)->age }} yrs)
                                </small>
                            @else
                                —
                            @endif
                    ...
                    <div class="col-sm-6 mb-3">
                        ...
                        <p class="mb-0">{{ $driver->gender ? 'Male' : 'Female' }}</p>
                    </div>
                    <div class="col-sm-6 mb-3">
                ...
                <div class="row">
                    <div class="col-sm-6 mb-3">
                        ...
                        <p class="mb-0 font-weight-bold text-success" style="font-size:1.3rem;">
                            ${{ number_format($driver->salary ?? 0, 2) }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <p class="mb-0">{{ $driver->created_at ? $driver->created_at->format('d M Y, h:i A') : '—' }}</p>
                    </div>
                    <div class="col-sm-6">
                        <p class="text-muted small mb-1">Last Updated</p>
                        <p class="mb-0">{{ $driver->updated_at ? $driver->updated_at->format('d M Y, h:i A') : '—' }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('drivers.destroy', $driver->id) }}" method="POST">
                ...
                <div class="modal-body">
                    <p>Are you sure you want to delete <strong>{{ $driver->name }}</strong>?</p>
