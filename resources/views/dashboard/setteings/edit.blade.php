                        ...
                        <div class="mb-4">
                            ...
                            @if($setting->logo)
                                <div class="mb-3">
                                    ...
                                    <p class="text-muted small mt-2">الشعار الحالي</p>
                                </div>
                            @endif
                            ...
                            <small class="form-text text-muted">
                                اختر صورة جديدة لتغيير الشعار (اختياري)
                            </small>
                            @error('logo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
    ...
    document.getElementById('logo').addEventListener('change', function(e) {
        if (e.target.files && e.target.files[0]) {
            ...
            reader.onload = function(event) {
                ...
                container.innerHTML = '<p class="text-muted small mb-2">معاينة الشعار الجديد:</p>';
